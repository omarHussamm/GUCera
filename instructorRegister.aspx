...
<body>
    <form id="form1" runat="server">
        <div>
            <div class="reg">Register as Instructor</div>
            ...
            <div class="in">
                password:&nbsp;
            <asp:TextBox ID="password" runat="server" maxlength="10"></asp:TextBox></div>
            <div class="in">
               email:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="email" runat="server" TextMode="Email" maxlength="50"></asp:TextBox></div>
            <div class="in">
               gender:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
